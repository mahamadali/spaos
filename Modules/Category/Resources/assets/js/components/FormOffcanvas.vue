      ...
      <div class="offcanvas-body">
        <div class="row">
          <div class="col-12">
            ...
            <div class="form-group" v-if="isSubCategory==true">
              ...
              <Multiselect v-bind="singleSelectOption" v-model="parent_id" :value="parent_id"  :placeholder="$t('category.category_select')" :options="categories"></Multiselect>
