...
@section('content')
            ...
            <x-slot name="toolbar">
              ...
              <div class="input-group flex-nowrap top-input-search">
                ...
                @hasPermission('add_category')
                  ...
                  <button type="button" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#categoryOffcanvas"  data-type="category"><i class="fas fa-plus-circle"></i> {{ __('messages.new') }}</button>
                @endhasPermission
            </x-slot>
          </x-backend.section-header>
    ...
    <div data-render="app">
        @include('category::backend.categories.form-offcanvas', ['customefield' => $customefield])

      {{-- <form-offcanvas
               :is-sub-category="false"
