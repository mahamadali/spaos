...
@section('content')
              ...
              <div class="d-flex flex-wrap gap-3">
                ...
                <x-slot name="toolbar">
                  ...
                  <div class="input-group flex-nowrap top-input-search">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#categoryOffcanvas"  data-type="subcategory" ><i class="fas fa-plus-circle"></i> {{ __('messages.new') }}</button>
                    @endhasPermission
                </x-slot>
            </x-backend.section-header>
    ...
    <div data-render="app">
        @include('category::backend.categories.form-offcanvas', ['isSubCategory' => $isSubCategory, 'categories' => $categories, 'customefield' => $customefield])
        {{-- <form-offcanvas
...
@push('after-scripts')
    ...
    <script src="{{ asset('modules/category/category-form.js') }}" defer></script>
