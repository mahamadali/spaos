...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth']], function () {
    ...
    */
    ...
    Route::get('sub-categories', [CategoriesController::class, 'index_nested'])->middleware(['auth', 'check.menu.permission'])->name('categories.index_nested');
    ...
    Route::resource('categories', CategoriesController::class)->middleware(['auth', 'check.menu.permission']);
});
