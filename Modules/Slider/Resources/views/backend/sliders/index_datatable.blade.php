...
<script type="text/javascript">
        ...
        { data: 'name', name: 'name', title: "{{ __('slider.lbl_name') }}",  width:'20%' },
        { data: 'url', name: 'link', title: "{{ __('slider.lbl_url') }}",  width:'20%'},
        { data: 'type', name: 'type', title: "{{ __('slider.lbl_type') }}",  width:'15%'},
        { data: 'link_id', name: 'link_id', title: "{{ __('slider.lbl_link_id') }}",  width:'15%'},
        { data: 'status', name: 'status', title: "{{ __('slider.lbl_status') }}", width:'10%'},
        {
            data: 'updated_at',
            name: 'updated_at',
