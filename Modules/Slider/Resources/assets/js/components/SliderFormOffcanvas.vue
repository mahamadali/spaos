  ...
  <form @submit="formSubmit">
    <div class="offcanvas offcanvas-end" tabindex="-1" id="form-offcanvas" aria-labelledby="form-offcanvasLabel">
      ...
      <div class="offcanvas-body">
        ...
        <InputField class="col-md-12" type="text" :is-required="false" :label="$t('slider.lbl_url')" :placeholder="$t('slider.enter_url')" v-model="link" :error-message="errors['link']" :error-messages="errorMessages['link']"></InputField>
...
const defaultData = () => {
  errorMessages.value = {}
  ImageViewer.value = null // Reset to null, defaultImage will be used via template
  return {
    name: '',
    type: '',
    link: '',
...
const setFormData = (data) => {
  if(data.feature_image && data.feature_image !== props.defaultImage) {
    ImageViewer.value = data.feature_image;
  } else {
    ImageViewer.value = null; // Will use defaultImage from props in template
  }
  resetForm({
    values: {
      name: data.name,
