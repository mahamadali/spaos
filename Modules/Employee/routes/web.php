...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'employees', 'as' => 'employees.'], function () {
        ...
        Route::post('employee-services/{employeeId}', [EmployeesController::class, 'addEmployeeService'])->name('employee-services.store');
        Route::delete('employee-services/{employeeId}/{serviceId}', [EmployeesController::class, 'destroyEmployeeService'])->name('employee-services.destroy');
  });
