...
class MenuBuildersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $message = __('messages.new_menu_add');
    ...
    public function update(Request $request, $id)
    {
        ...
        $message = __('messages.menu_update');
    ...
    public function destroy($id)
    {
        ...
        $message = __('messages.menu_delete');
    ...
    public function update_sequance(Request $request)
    {
        ...
        if (count($menuArr) > 0) {
            ...
            return response()->json(['message' => __('messages.menu_update'), 'status' => true]);
        }
