<div class="d-flex gap-2 align-items-center">
    @hasPermission('customer_password')
        <button type='button' data-assign-module="{{ $data->id }}" data-assign-target='#Customer_change_password'
    ...
    @hasPermission('edit_customer')
        <button type="button" class="btn btn-primary btn-sm" data-customer-id="{{ $data->id }}"
