<form id="employeeChangePasswordForm">
  <div class="offcanvas offcanvas-end" id="Customer_change_password" aria-labelledby="form-offcanvasLabel">
        ...
        <div class="col-12">
          <div class="form-group">
            ...
            <div class="form-group mb-3">
               ...
               {{-- New Password --}}
            <div class="form-group mb-3">
                <label class="form-label">{{ __('messages.new_password') }} <span class="text-danger">*</span></label>
                <div class="position-relative">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (e) {
        ...
        fetch("{{ route('backend.customers.change_password') }}", {
            method: "POST",
            headers: {
        ...
        .then(res => {
            if (res.status) {
                ...
                bootstrap.Offcanvas.getInstance('#Customer_change_password').hide();
                resetForm();
                window.currentId = 0;
            } else {
