...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth']], function () {
    ...
    */
    ...
    Route::group(['prefix' => 'customers', 'as' => 'customers.'], function () {
        ...
        Route::get('verify', [CustomersController::class, 'verifyLimit'])->name('verify');


    });
    Route::resource('customers', CustomersController::class)->middleware(['auth', 'check.menu.permission']);
});
