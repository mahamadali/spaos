      ...
      <div class="offcanvas-body">
            ...
            <div class="form-group">
              ...
              <div class="d-flex justify-content-between align-items-center form-control">
                <label class="form-label mb-0" for="status">{{ $t('constant.lbl_status') }}</label>
...
const validationSchema = yup.object({
  ...
  type: yup.string()
    .required(t('messages.type_required'))
    .test('is-string', t('messages.only_strings_allowed'), (value) => !numberRegex.test(value)),
  value: yup.string().required(t('messages.value_required')),
  status: yup.boolean()
})
