<template>
  <form @submit="formSubmit">
    <div class="form-group">
      <label class="form-label">{{$t('messages.lbl_location')}}</label>
      ...
      <template v-if="has_variation">
        <table class="table">
          <thead>
            <tr>
              <th>
                <label for="" class="control-label">{{$t('messages.variation')}}</label>
              </th>
              <th data-breakpoints="xs sm">
                <label for="" class="control-label">{{$t('messages.stock')}}</label>
              </th>
            </tr>
          </thead>
          <tbody>
    ...
    <div class="form-group">
      <button type="submit" class="btn btn-primary" :disabled="!product_id"> {{ $t('messages.submit') }} </button>
    </div>
  </form>
</template>
