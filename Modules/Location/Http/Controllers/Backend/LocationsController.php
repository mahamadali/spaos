...
class LocationsController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = __('location.title');
        // module name
    ...
    public function store(Request $request)
    {
        ...
        $message = __('messages.locations_created_successfully');
    ...
    public function update(Request $request, $id)
    {
        ...
        $message = __('messages.locations_updated_successfully');
    ...
    public function destroy($id)
    {
        ...
        $message = __('messages.locations_deleted_successfully');
