<div class="d-flex gap-2 align-items-center">
    <button type='button'
        ...
        data-custom-target='#form-offcanvas-stock-blade' data-custom-event='custom_form'
    ...
    <a href="{{ route('backend.products.destroy', $data->id) }}" id="delete-{{ $module_name }}-{{ $data->id }}"
        ...
        data-confirm="{{ __('messages.you_want_to_delete?', ['module' => __('product.singular_title'), 'name' => $data->name]) }}">
