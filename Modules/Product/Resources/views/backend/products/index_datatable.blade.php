...
@section('content')
            ...
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    @hasPermission('add_product')
                        <button type="button" class="btn btn-primary d-inline-flex align-items-center gap-2" data-bs-toggle="offcanvas" data-bs-target="#form-offcanvas">
    ...
    <div data-render="app">
        {{-- Product Offcanvas Form --}}
        @include('backend.product.form_offcanvas', [
            'defaultImage' => product_feature_image(),
            'editTitle' => __('messages.edit') . ' ' . __('product.singular_title'),
            'createTitle' => __('messages.new') . ' ' . __('product.singular_title'),
        ])
    </div>
    @include('product::backend.products.stock_offcanvas')
    @include('product::backend.products.gallery_offcanvas')
