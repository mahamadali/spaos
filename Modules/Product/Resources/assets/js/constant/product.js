...
// Subcategories (children) list filtered by parent category and optional brand
export const SUBCATEGORY_LIST = ({parent_id, brand_id}) => {return {path: `products-categories/index_list?parent_id=${parent_id ?? ''}&brand_id=${brand_id ?? ''}`, method: 'GET'}}