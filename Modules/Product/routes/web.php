...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth']], function () {
    ...
    */
    ...
    Route::group(['prefix' => 'orders'], function () {
        ...
        Route::get('get-discounted-price', [OrdersController::class, 'getDiscountedProductPrice'])->name('orders.get-discounted-price');
        Route::get('get-states', [OrdersController::class, 'getStates'])->name('orders.getStates');
        Route::get('get-cities', [OrdersController::class, 'getCities'])->name('orders.getCities');
        Route::post('add-address', [OrdersController::class, 'storeAddress'])->name('orders.store_address');
        Route::get('orders/get-addresses', [OrdersController::class, 'getAddresses'])->name('orders.get_addresses');
        Route::post('add-to-cart', [OrdersController::class, 'addToCart'])->name('orders.add_to_cart');
    });
});
