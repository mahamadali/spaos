    ...
    public function run()
    {
        ...
        if (env('IS_DUMMY_DATA')) {
            foreach ($data as $key => $value) {
                ...
                if ($key < 3) {
                    // First 3 product categories get only 5 brands
                    $product_category->brands()->sync([1, 2, 3, 4, 5]);
                } else {
                    // All brands for other product categories
