        ...
        <x-backend.section-header>
            ...
            <x-slot name="toolbar">
                ...
                @hasPermission('add_tax')
                    <button type="button" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#tax-form-offcanvas" aria-controls="tax-form-offcanvas" id="newTaxBtn">
...
@include('tax::backend.tax.form_offcanvas', ['createTitle' => __('messages.create') . ' ' . $module_title, 'editTitle'   => __('messages.edit') . ' ' . $module_title,])
