        ...
        <div class="row">
          <div class="col-12">
            <div class="form-group">
              ...
              <span class="text-danger d-block mb-1" v-if="errors.type">{{ errors.type }}</span>
              <Multiselect
                id="type"
                v-model="type"
                :value="type"
          ...
          <div class="col-12 mb-3">
            <label class="form-label" for="module_type">{{ $t('tax.lbl_module_type') }} <span class="text-danger">*</span></label>
            <span class="text-danger d-block mb-1" v-if="errors.module_type">{{ errors.module_type }}</span>
            <Multiselect
              id="module_type"
...
const validationSchema = yup.object({
  title: yup.string()
    ...
    .test('no-spaces-only', 'Title cannot contain only spaces', (value) => value ? value.trim().length > 0 : true),
    value: yup.string()
