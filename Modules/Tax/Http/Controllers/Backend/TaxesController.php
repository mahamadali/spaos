...
class TaxesController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = __('tax.title');
    ...
    public function index(Request $request)
    {
        ...
        $module_title = __('tax.title');
        return view('tax::backend.tax.index_datatable', compact('module_action', 'filter','module_title'));
    }
    ...
    public function index_data(Datatables $datatable, Request $request)
    {
        ...
        return $datatable->eloquent($query)
            ...
            ->editColumn('module_type', function ($data) {
                return $data->module_type ? ucwords($data->module_type) : '-';
            })
