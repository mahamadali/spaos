              ...
              <nav aria-label="Pagination">
                <ul class="pagination justify-content-end">
                  ...
                  <li class="page-item" :class="{ disabled: currentPage === 1 }">
                    <button @click="prevPage" class="page-link" :disabled="currentPage === 1">{{ $t('messages.lbl_previous') }}</button>
                  </li>
                  ...
                  <li class="page-item" :class="{ disabled: currentPage === totalPages }">
                    <button @click="nextPage" class="page-link" :disabled="currentPage === totalPages">{{ $t('messages.lbl_next') }}</button>
                  </li>
                </ul>
              </nav>
            </div>
