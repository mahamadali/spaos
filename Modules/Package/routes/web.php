...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth']], function () {
    ...
    */
    ...
    Route::resource('package', PackagesController::class)->middleware(['auth', 'check.menu.permission']);
    Route::get('client-package', [PackagesController::class, 'clientView'])->middleware(['auth', 'check.menu.permission'])->name('clientPackage');
});
