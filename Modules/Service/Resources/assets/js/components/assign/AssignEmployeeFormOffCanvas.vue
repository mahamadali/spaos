        ...
        <div class="form-group">
          <div class="d-grid">
            <div class="d-flex flex-column">
              <div class="mb-4">
                <Multiselect v-model="assign_ids" placeholder=""  :value="assign_ids" :canClear="false" v-bind="singleSelectOption" :options="employee.options" @select="selectEmployee" id="employees_ids">
            ...
            <div class="list-group list-group-flush">
              <div v-for="(item, index) in selectedEmployee" :key="item" class="list-group-item d-flex justify-content-between align-items-center mb-2 border-0 rounded">
