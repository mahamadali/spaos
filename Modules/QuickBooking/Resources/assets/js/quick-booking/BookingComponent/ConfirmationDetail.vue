                        ...
                        <div class="iq-card-body">
                            <table class="iq-table-border mb-0" style="border:0;">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="width: 15em;" class="mb-2"> {{ formatBranchAddress(booking) }}</p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
const formatBranchAddress = (booking) => {
  if (!booking || !booking.branch) return 'N/A';
  ...
  if (branch.address && typeof branch.address === 'object') {
    ...
    // Check if address fields are directly on branch object
  ...
  return parts.length > 0 ? parts.join(', ') : (booking.branch_address || 'N/A');
}
