...
class SubscriptionController extends Controller
{
    ...
    public function cancelSubscription($subscription_plan_id)
    {
        $user_id = auth()->id();
        $user_subscription = Subscription::where('id', $subscription_plan_id)
        ...
        return $this->sendResponse($subscription_plan_id, __('messages.subscribe_cancel'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $subscription->cancelExistingPlan($user_id);
        ...
        // Rest of your existing store method code...
    }
}
