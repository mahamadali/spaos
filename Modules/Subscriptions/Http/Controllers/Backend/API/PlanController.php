...
class PlanController extends Controller
{
    ...
    {
        return $this->sendResponse(PlanResource::collection(Plan::with('planLimitation')->get()), __('messages.plan_list'));
    }
    ...
    public function store(PlanRequest $request)
    {
        ...
        return $this->sendResponse(new PlanResource($plandata), __('messages.plan_create'));
    }
    ...
    {
        return $this->sendResponse(new PlanResource($plan), __('messages.plan_detail'));
    }
    ...
    public function update(PlanRequest $request, Plan $plan)
    {
        ...
        return $this->sendResponse(new PlanResource($plan), );
    }
    ...
    public function destroy(Plan $plan)
    {
        ...
        return $this->sendResponse($id, __('messages.plan_delete'));
    }
}
