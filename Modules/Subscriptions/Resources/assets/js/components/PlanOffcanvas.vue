  ...
  <form @submit="formSubmit">
    <div class="offcanvas offcanvas-end" tabindex="-1" id="form-offcanvas" aria-labelledby="form-offcanvasLabel">
      ...
      <div class="offcanvas-body">
        <div class="row">
          <div class="col-12">
            <InputField class="col-md-6" :is-required="true" :label="Name"  placeholder="" v-model="name" :error-message="errors.name" :error-messages="errorMessages['name']"></InputField>
            <div class="form-group">
              <label class="form-label" for="type">Name <span class="text-danger">*</span> </label>
            ...
            <div class="form-group" v-if="planlimitation === 'Limited'" id="limitation_data">
              ...
              <a href="/app/subscription/planlimitation"
                ><h6 for="planlimitation_id" style="float: right"><i class="fa fa-plus-circle" aria-hidden="true"></i>{{$t('messages.create_limitation')}}</h6>
              </a>
...
const validationSchema = yup.object({
  name: yup.string()
    .required(t('messages.name_required'))
    .test('is-string', t('messages.only_strings_allowed'), (value) => !numberRegex.test(value)),
  type: yup.string().required(t('messages.type_required')),
  amount: yup.string()
    .required(t('messages.amount_required'))
    .matches(/^\d+$/, t('messages.only_numbers_allowed'))
    .min(0,t('messages.amount_min')),
  planlimitation: yup.string().required(t('messages.plan_limitation_required'))
})
