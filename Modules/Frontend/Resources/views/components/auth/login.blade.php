...
<section class="login-page">
    <div class="login-card-box">
        <div class="text-center mb-4">
            ...
            <h4 class="theme-color">{{__('messages.welcome_back!')}}</h4>
            <p class="theme-color">{{__('messages.you_have_been_missed_for_long_time')}}</p>
        </div>

        {{-- ====== KEEP EXACT SAME FORM CONTENT BELOW ====== --}}
        @if (session('error'))
