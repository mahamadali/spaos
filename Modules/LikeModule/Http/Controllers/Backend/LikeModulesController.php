...
class LikeModulesController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = __('likemodule.title');
        // module name
    ...
    public function store(Request $request)
    {
        ...
        $message = __('messages.new_likeModule_added');
    ...
    public function update(Request $request, $id)
    {
        ...
        $message = __('messages.update_likemodule');
    ...
    public function destroy($id)
    {
        ...
        $message = __('messages.delete_likemodule');
