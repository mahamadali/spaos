...
@php
    ...
    if (isset($module_action)) {
        $candidate = is_string($module_action) ? __($module_action) : $module_action;
        if (is_string($candidate)) {
            $titleParts[] = $candidate;
        }
    }
    if (isset($module_title)) {
        $candidate = is_string($module_title) ? __($module_title) : $module_title;
        if (is_string($candidate)) {
            $titleParts[] = $candidate;
        }
    }
...
@section('content')
    ...
    <div data-render="app">
        @include('logistic::backend.logistics.form_offcanvas', [
            'defaultImage' => default_feature_image(),
            'createTitle' => __('messages.new') . ' ' . __('logistics.singular_title'),
            'editTitle' => __('messages.edit') . ' ' . __('logistics.singular_title'),
