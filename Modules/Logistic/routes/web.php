...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth']], function () {
    ...
    */
    ...
    Route::resource('logistics', LogisticsController::class)->middleware(['auth', 'check.menu.permission']);
    ...
    Route::resource('logistic-zones', LogisticZoneController::class)->middleware(['auth', 'check.menu.permission']);
});
