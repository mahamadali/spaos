...
class LogisticZoneController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = __('logistic_zone.title');
        // module name
    ...
    public function index(Request $request)
    {
        ...
        $module_title = __('logistic_zone.title');
        ...
        return view('logistic::backend.zone.index_datatable', compact('module_action', 'filter', 'export_import', 'export_columns', 'export_url','module_title'));
    }
    ...
    {
        $query = LogisticZone::with('cities')->where('created_by', auth()->user()->id);
    ...
    public function store(ZoneRequest $request)
    {
        ...
        $message = __('messages.shippzon_added');
    ...
    public function update(ZoneRequest $request, $id)
    {
        ...
        $message = __('messages.shippzon_update');
    ...
    public function destroy($id)
    {
        ...
        $message = __('messages.shippzon_delete');
