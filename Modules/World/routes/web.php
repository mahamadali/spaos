...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth']], function () {
    ...
    */
    ...
    Route::resource('country', CountryController::class)->middleware(['auth', 'check.menu.permission']);
    ...
    Route::resource('state', StateController::class)->middleware(['auth', 'check.menu.permission']);
    ...
    Route::resource('city', CityController::class)->middleware(['auth', 'check.menu.permission']);
});
