...
class CountryController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = __('country.title');
        // module name
    ...
    public function index(Request $request)
    {
        ...
        $module_title = __('country.title');
        $module_action = __('messages.list');

        return view('world::backend.country.index_datatable', compact('module_action', 'filter','module_title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $message =  __('messages.new_country');
    ...
    public function update(Request $request, $id)
    {
        ...
        $message = __('messages.country_update');
