...
class StateController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = __('state.title');
        // module name
    ...
    public function index(Request $request)
    {
        ...
        $module_title = __('state.title');
        $module_action = __('messages.list');

        return view('world::backend.state.index_datatable', compact('module_action', 'filter','module_title'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $message = __('messages.state_update');
    ...
    public function destroy($id)
    {
        ...
        $message = __('messages.state_delete');
