...
class BackendBaseController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = __('messages.lbl_modules');
    ...
    public function store(Request $request)
    {
        ...
        $module_action = __('messages.store');
    ...
    public function destroy($id)
    {
        ...
        $module_action = __('messages.destory');
    ...
    public function restore($id)
    {
        ...
        flash('<i class="fas fa-check"></i> '.label_case($module_name_singular). __('messages.tips_data_store'))->success()->important();
