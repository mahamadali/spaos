...
(function () {
    ...
    this.IQUtils.getColorShadeTint = (color, value, dark) => {
        ...
        if(dark) {
          ...
          colors[color] = value;
          colors[`${color}-bg-subtle`] = tintColor(value, 80);
          colors[`${color}-border-subtle`] = tintColor(value, 80);
          colors[`${color}-hover-bg`] = shadeColor(value, 20);
          colors[`${color}-hover-border`] = shadeColor(value, 30);
          colors[`${color}-active-bg`] = shadeColor(value, 20);
          colors[`${color}-active-border`] = shadeColor(value, 30);
        } else {
