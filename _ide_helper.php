...
namespace App\Currency {
    ...
    class CurrencyFacades {
         ...
         * @static
         */
        public static function getVendorDefaultCurrency()
        {
            /** @var \App\Currency\CurrencyChange $instance */
            return $instance->getVendorDefaultCurrency();
        }
         ...
         * @static
         */
        public static function vendorCurrencyFormate($amount)
        {
            /** @var \App\Currency\CurrencyChange $instance */
            return $instance->vendorCurrencyFormate($amount);
        }
