      ...
      <div class="col-12 row">
        <div class="col-md-8">
          <div class="row">
            ...
            <InputField class="col-md-6" :is-required="true" :label="$t('profile.Vendor_Website_Identifier')" :value="slug" v-model="slug" :placeholder="$t('profile.enter_Vendor_Website_Identifier')" :error-message="errors['slug']"></InputField>
...
const validationSchema = yup.object({
  ...
  slug: yup.string()
    .matches(/^[a-z0-9-]+$/, t('messages.slug_validation_error'))
    .required(t('messages.slug_required'))
})
