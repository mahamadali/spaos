...
const BRANCH_FOR_OPTIONS = reactive([
  { id: 'unisex', text: t('messages.unisex') },
  { id: 'female', text: t('messages.female') },
  { id: 'male', text: t('messages.male') }
  // Add more options as needed
])

const PAYMENT_METHODS_OPTIONS = reactive([
  { id: 'upi', text: t('messages.lbl_upi') },
  { id: 'cash', text: t('messages.lbl_cash') },
  { id: 'razorpay', text: t('messages.lbl_razorpay') },
  { id: 'stripe', text: t('messages.lbl_stripe') }
  // Add more options as needed
])
...
const validationSchema = yup.object({
  ...
  contact_number: yup
    .string()
    .required(t('messages.contact_number_required'))
    .matches(/^(\+?\d+)?(\s?\d+)*$/, t('messages.phone_invalid')),
  ...
  address: yup.object({
    ...
    city: yup.string().required(t('messages.city_required')),
    latitude: yup.string().required(t('messages.latitude_required')),
    longitude: yup.string().required(t('messages.longitude_required')),
    state: yup.string().required(t('messages.state_required')),
