  ...
  <form @submit.prevent="formSubmit">
    <div class="offcanvas offcanvas-end" tabindex="-1" id="branch-gallery-form" aria-labelledby="form-offcanvasLabel">
      ...
      <div class="d-flex flex-column border-bottom p-3">
        <div class="">
          <label class="form-label btn btn-secondary d-block my-0" for="branch_feature_image">{{ $t('messages.upload_images') }}</label>
...
const removeImage = (index) => {
  ...
  window.successSnackbar(t('messages.image_removed'))
}
