...
const DEFAULT_LOGO = window.asset ? window.asset('img/logo/logo.png') : '/img/logo/logo.png'
const DEFAULT_MINI_LOGO = window.asset ? window.asset('img/logo/mini_logo.png') : '/img/logo/mini_logo.png'
const DEFAULT_DARK_LOGO = window.asset ? window.asset('img/logo/dark_logo.png') : '/img/logo/dark_logo.png'
const DEFAULT_DARK_MINI_LOGO = window.asset ? window.asset('img/logo/mini_logo.png') : '/img/logo/mini_logo.png'
const DEFAULT_FAVICON = window.asset ? window.asset('img/logo/mini_logo.png') : '/img/logo/mini_logo.png'
...
const setFormData = (data) => {
    ...
    resetForm({
      values: {
        app_name: data.app_name ?? 'Frezka Saas',
        footer_text: data.footer_text ?? 'Builttt with ♥ from <a href="https://iqonic.design" target="_blank">IQONIC DESIGN.</a>',
        ui_text: data.ui_text ?? 'UI Powered By <a href="https://hopeui.iqonic.design/" target="_blank">HOPE UI</a>',
        copyright_text: data.copyright_text ?? 'Copyright',
        helpline_number: data.helpline_number ?? '1234567890',
        inquriy_email: data.inquriy_email ?? 'frezka-saas@admin.com',
        site_description: data.site_description ?? 'Discover effortless beauty bookings with expert stylists, exclusive offers, and a seamless experience — all from one smart platform.',
        logo: '',
        mini_logo: '',
        dark_logo: '',
        dark_mini_logo: '',
        favicon: '',
        bussiness_address_line_1: data.bussiness_address_line_1 ?? '140 Coxs Rd',
        bussiness_address_line_2: data.bussiness_address_line_2 ?? 'North Ryde, NSW 2113',
        bussiness_address_country: data.bussiness_address_country ?? 'Australia',
        bussiness_address_state: data.bussiness_address_state ?? 'New South Wales',
        bussiness_address_city: data.bussiness_address_city ?? 'Sydney',
        bussiness_address_postal_code: data.bussiness_address_postal_code ?? '2230',
        bussiness_address_latitude: data.bussiness_address_latitude ?? '-33.8688',
        bussiness_address_longitude: data.bussiness_address_longitude ?? '151.2093'
      }
    })
}
...
const formSubmit = handleSubmit((values) => {
  ...
  Object.entries(values).forEach(([key, value]) => {
    // Handle image removal - send null to backend for logo fields
    if (value === 'REMOVE_IMAGE' && ['logo', 'mini_logo', 'dark_logo', 'dark_mini_logo', 'favicon'].includes(key)) {
