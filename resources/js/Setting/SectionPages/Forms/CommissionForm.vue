...
const type_commission = ref({
  ...
  options: [
    ...
    { label: t('messages.lbl_percentage'), value: 'percentage' },
    { label: t('messages.lbl_fixed'), value: 'fixed' }
  ],
  closeOnSelect: true
})
...
const validationSchema = yup.object({
  title: yup.string()
    .required(t('messages.title_required'))
    .test('is-string', t('messages.only_strings_allowed'), (value) => !numberRegex.test(value)),
  commission_value: yup.string()
    .required(t('messages.commission_value_required'))
    .matches(/^\d+(\.\d+)?$/,t('messages.only_numbers_allowed')),
  commission_type: yup.string()
    .required(t('messages.commission_type_required'))
})
