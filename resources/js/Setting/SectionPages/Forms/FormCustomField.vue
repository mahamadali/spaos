                ...
                <div class="form-group" v-if="type === 'select' || type === 'radio' || type === 'checkbox'">
                  <div v-for="(input, index) in inputFields" :key="index" class="mb-3 mt-3">
                    ...
                    <div class="d-flex">
                      ...
                      <a v-if="inputFields.length > 1" class="btn btn-primary ms-2" @click="deleteInputField(index)">Delete</a>
                    </div>
                  </div>
                  <div class="mb-4">
...
const validationSchema = yup.object({
  ...
  label: yup.string().required(t('messages.label_is_required')),
  type: yup.string().required(t('messages.type_is_required'))
})
