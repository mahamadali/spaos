...
const validationSchema = yup.object({
  ...
  mail_driver: yup.string().required(t('messages.mail_driver_required')),
  mail_host: yup.string().required(t('messages.mail_host_required')),
  mail_port: yup.string().required(t('messages.mail_port_required')),
  mail_encryption: yup.string().required(t('messages.mail_encryption_required')),
  mail_username: yup
    .string()
    .required(t('messages.mail_username_required'))
    .test('is-string', t('messages.only_strings_allowed'), (value) => !numberRegex.test(value)),
  mail_password: yup.string().required(t('messages.password_required')),
  mail_from: yup
    .string()
    .required(t('messages.mail_from_required'))
    .test('is-string', t('messages.only_strings_allowed'), (value) => !numberRegex.test(value))
    .matches(EMAIL_REGX, t('messages.valid_email')),
  from_name: yup.string().required(t('messages.from_name_required'))
})
