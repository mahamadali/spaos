  ...
  <div>
    <div class="d-flex align-items-center justify-content-between">
      ...
      <div class="d-flex align-items-center">
        <a href="#custom-color" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="custom-color">{{ $t('messages.lbl_custom') }}</a>
    ...
    <div class="collapse" id="custom-color">
      <div class="form-group d-flex justify-content-between align-items-center">
        <label for="custom-primary-color"> {{ $t('messages.primary') }} </label>
      ...
      <div class="form-group d-flex d-flex justify-content-between align-items-center">
        <label for="custom-secondary-color">{{ $t('messages.secondary') }}</label>
