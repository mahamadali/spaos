                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <i class="far fa-check-circle me-1"></i>{{ $permission->name }}&nbsp;
                                                @endforeach
                                                @else
                                                {{ __("messages.none") }}
                                                @endif
                                                @else
                                                {{ __("messages.all_prmissions") }}
                                                @endif
                                            </div>
                                        </div>
                                        <!--card-->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="float-end">
                            ...
                            <a href="{{route('backend.users.unblock', $$module_name_singular)}}" class="btn btn-secondary" data-method="PATCH" data-token="{{csrf_token()}}" data-bs-toggle="tooltip" title="{{__('labels.backend.unblock')}}" data-confirm="{{ __('messages.are_you_sure?') }}"><i class="fas fa-check"></i> Unblock</a>
                            @endif
                            ...
                            @endif
                            <x-backend.buttons.return-back>{{ __("messages.cancel") }}</x-backend.buttons.return-back>
                        </div>
                    </div>
                </div>
                {{ html()->closeModelForm() }}
        ...
        <div class="row">
            <div class="col">
                <small class="float-end text-muted">
                    {{ __("messages.update") }}: {{$user->updated_at->diffForHumans()}},
                    {{ __("messages.created_at") }}: {{$user->created_at->isoFormat('LLLL')}}
                </small>
            </div>
        </div>
    </div>
