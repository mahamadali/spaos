<div class="row">
            ...
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center justify-content-between">
                        <h6> {{ __("messages.color_customizer") }}</h6>
                        <div class="d-flex align-items-center">
                            <div data-setting="radio">
                                ...
                                <label class="btn bg-transparent border-0" for="theme-color-default"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('messages.reset_color') }}"
                                    data-bs-original-title="{{ __('messages.reset_color') }}">
                    ...
                    <div class="grid-cols-5 mb-4 d-grid gap-3">
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-block bg-transparent" for="theme-color-1"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('messages.theme_1') }}"
                                data-bs-original-title="{{ __('messages.theme_1') }}">
                        ...
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-block bg-transparent" for="theme-color-2"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('messages.theme_2') }}"
                                data-bs-original-title="{{ __('messages.theme_2') }}">
                                <svg class="customizer-btn" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" width="26" height="26">
                        ...
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-block bg-transparent" for="theme-color-3"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('messages.theme_3') }}"
                                data-bs-original-title="{{ __('messages.theme_3') }}">
                                <svg class="customizer-btn" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" width="26" height="26">
                        ...
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-block bg-transparent" for="theme-color-4"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('messages.theme_4') }}"
                                data-bs-original-title="{{ __('messages.theme_4') }}">
                                <svg class="customizer-btn" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" width="26" height="26">
                        ...
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-block bg-transparent" for="theme-color-5"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('messages.theme_5') }}"
                                data-bs-original-title="{{ __('messages.theme_5') }}">
                                <svg class="customizer-btn" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" width="26" height="26">
                    ...
                    <div class="d-grid gap-3 grid-cols-3 mb-3">
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-flex align-items-center bg-transparent"
                                ...
                                title="{{ __('messages.sidebar_white') }}" data-bs-original-title="{{ __('messages.sidebar_white') }}">
                                <i class="text-white">
                                ...
                                <span class="ms-2 ">{{ __('messages.default') }}</span>
                            </label>
                        </div>
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-flex align-items-center bg-transparent"
                                ...
                                title="{{ __('messages.sidebar_dark') }}" data-bs-original-title="{{ __('messages.sidebar_dark') }}">
                                <i class="text-dark">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon-18"
                                        width="18" viewBox="0 0 24 24" fill="currentColor">
                                        <circle cx="12" cy="12" r="8"
                        ...
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-flex align-items-center bg-transparent"
                                ...
                                title="{{ __('messages.sidebar_colored') }}" data-bs-original-title="{{ __('messages.sidebar_colored') }}">
                                ...
                                <span class="ms-2 ">{{ __('messages.color') }}</span>
                            </label>
                        </div>
                    </div>
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-flex align-items-center bg-transparent"
                                ...
                                data-bs-placement="top" title="{{ __('messages.sidebar_transparent') }}"
                                data-bs-original-title="{{ __('messages.sidebar_transparent') }}">
                                <i class="text-dark">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon-18"
                                        width="18" viewBox="0 0 24 24" fill="currentColor">
                                        <circle cx="12" cy="12" r="8"
                                ...
                                <span class="ms-2">{{ __('messages.transparent') }}</span>
                            </label>
                        </div>
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-flex align-items-center bg-transparent"
                                ...
                                title="{{ __('messages.sidebar_glass') }}" data-bs-original-title="{{ __('messages.sidebar_glass') }}">
                                <i class="text-dark">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon-18"
                                        width="18" viewBox="0 0 24 24" fill="currentColor">
                                        <circle cx="12" cy="12" r="8"
                                ...
                                <span class="ms-2">{{ __('messages.glass') }}</span>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="d-grid gap-3 grid-cols-4 mb-4">
                        <div data-setting="checkbox" class="text-center">
                            ...
                            <label class="btn btn-border d-block overflow-hidden" for="sidebar-mini">{{ __('messages.mini') }}</label>
                        </div>
                        <div data-setting="checkbox" class="text-center">
                            ...
                            <label class="btn btn-border d-block overflow-hidden" for="sidebar-hover">{{ __('messages.hover') }}</label>
                        </div>
                        <div data-setting="checkbox" class="text-center">
                            <input type="checkbox" value="sidebar-boxed" class="btn-check" name="sidebar_type" id="sidebar-boxed">
                            <label class="btn btn-border d-block overflow-hidden" for="sidebar-boxed">{{ __('messages.boxed') }}</label>
                        </div>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <div>
                    <h6>{{ __('messages.active_menu_style') }}</h6>
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div data-setting="radio" class="text-center">
                            ...
                            <label class="btn btn-border d-block overflow-hidden" for="navs-rounded">{{ __('messages.rounded_one_side') }}</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="sidebar-default navs-rounded-all" class="btn-check" name="sidebar_menu_style" id="navs-rounded-all">
                            <label class="btn btn-border d-block overflow-hidden" for="navs-rounded-all">{{ __('messages.rounded_all') }}</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="sidebar-default navs-pill" class="btn-check" name="sidebar_menu_style" id="navs-pill">
                            <label class="btn btn-border d-block overflow-hidden" for="navs-pill">{{ __('messages.pill_one_side') }}</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value=" sidebar-default navs-pill-all" class="btn-check" name="sidebar_menu_style" id="navs-pill-all">
                            <label class="btn btn-border d-block overflow-hidden" for="navs-pill-all">{{ __('messages.pill_all') }}</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="left-bordered" class="btn-check" name="sidebar_menu_style" id="left-bordered" checked>
                            <label class="btn btn-border d-block overflow-hidden" for="left-bordered">{{ __('messages.left_bordered') }}</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="sidebar-default navs-full-width" class="btn-check" name="sidebar_menu_style" id="navs-full-width">
                            <label class="btn btn-border d-block overflow-hidden" for="navs-full-width">{{ __('messages.full_width') }}</label>
                        </div>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <div data-setting="checkbox">
                    <div class="d-flex align-item-center">
                        <h6 class="me-5">{{ __('messages.menu_hide') }}</h6>
    ...
    <div class="col-6">
        <div class="card">
            <div class="card-body">
                <div>
                    <h6>{{ __('messages.custom_color') }}</h6>
                    <div class="card">
                        <div class="card-body">
                            <div id="custom-color">
                                <div class="form-group d-flex justify-content-between align-items-center">
                                    <label class="" for="custom-primary-color">{{ __('messages.primary') }}</label>
                                ...
                                <div class="form-group d-flex d-flex justify-content-between align-items-center">
                                    <label class="" for="custom-info-color">{{ __('messages.secondary') }}</label>
                ...
                <hr class="hr-horizontal">
                <div>
                    <h6 class="d-inline-block mb-0 me-2">{{ __('messages.card_style') }}</h6>
                    <div class="d-grid gap-3 grid-cols-2 mb-3">
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-block" for="card-default" data-bs-toggle="tooltip"
                                ...
                                <span>{{ __('messages.default_style') }}</span>
                            </label>
                        </div>
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-block" for="card-glass" data-bs-toggle="tooltip"
                                ...
                                <span>{{ __('messages.glass_effect') }}</span>
                            </label>
                        </div>
                    </div>
                    <div data-setting="radio">
                        ...
                        <label class="btn btn-border d-block" for="card-transparent" data-bs-toggle="tooltip"
                            ...
                            <span>{{ __('messages.transparent_style') }}</span>
                        </label>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <div>
                    <h6>{{ __('messages.page_style') }} </h6>
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div data-setting="radio">
                            <input type="radio" value="container" class="btn-check" name="page_layout"
                                id="page-layout-boxed">
                            <label class="btn btn-border d-block" for="page-layout-boxed">{{ __('messages.boxed') }}</label>
                        </div>
                        <div data-setting="radio">
                            <input type="radio" value="container-fluid" class="btn-check"
                                name="page_layout" id="page-layout-full-width" checked>
                            <label class="btn btn-border d-block" for="page-layout-full-width">{{ __('messages.full_width') }}
                                </label>
                        </div>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <div>
                    <h6>{{ __('messages.style_appearance') }} </h6>
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div data-setting="checkbox">
                            <input type="checkbox" value="theme-flat" class="btn-check"
                                name="theme_style_appearance" id="theme-style-appearance-flat">
                            <label class="btn btn-border d-block" for="theme-style-appearance-flat">{{ __('messages.flat') }}</label>
                        </div>
                        <div data-setting="checkbox">
                            ...
                            <label class="btn btn-border d-block"
                                for="theme-style-appearance-bordered">{{ __('messages.bordered') }}</label>
                        </div>
                        <div data-setting="checkbox">
                            <input type="checkbox" value="theme-sharp" class="btn-check"
                                name="theme_style_appearance" id="theme-style-appearance-sharp">
                            <label class="btn btn-border d-block"
                                for="theme-style-appearance-sharp">{{ __('messages.sharp') }}</label>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <div>
                    <h6>{{ __('messages.navbar_style') }}</h6>
                    <div class="d-grid gap-3 grid-cols-4 mb-4">
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="nav-glass" class="btn-check" name="header_navbar" id="nav-glass">
                            <label class="btn btn-border d-block overflow-hidden" for="nav-glass">{{ __('messages.glass') }}</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="navs-sticky" class="btn-check" name="header_navbar" id="navs-sticky">
                            <label class="btn btn-border d-block overflow-hidden" for="navs-sticky">{{ __('messages.sticky') }}</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="navs-transparent" class="btn-check" name="header_navbar" id="navs-transparent">
                            <label class="btn btn-border d-block overflow-hidden" for="navs-transparent">{{ __('messages.transparent') }}</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="navs-default" class="btn-check" name="header_navbar" id="navs-default" checked>
                            <label class="btn btn-border d-block overflow-hidden" for="navs-default">{{ __('messages.default') }}</label>
                        </div>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <div data-setting="checkbox">
                    <div class="d-flex">
                        <h6 class="me-5">{{ __('messages.navbar_hide') }}</h6>
                        <div class="form-check form-switch">
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <div>
                    <h6>{{ __('messages.footer') }}</h6>
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div data-setting="radio">
                            <input type="radio" value="default" class="btn-check" name="footer" id="footer_default" checked>
                            <label class="btn btn-border d-block" for="footer_default">{{ __('messages.default') }}</label>
                        </div>
                        <div data-setting="radio">
                            <input type="radio" value="sticky" class="btn-check" name="footer" id="footer_Sticky">
                            <label class="btn btn-border d-block" for="footer_Sticky">{{ __('messages.sticky') }}</label>
                        </div>
                        <div data-setting="radio">
                            <input type="radio" value="glass" class="btn-check" name="footer" id="footer_glass">
                            <label class="btn btn-border d-block" for="footer_glass">{{ __('messages.glass') }}</label>
                        </div>
                    </div>
                </div>
            </div>
