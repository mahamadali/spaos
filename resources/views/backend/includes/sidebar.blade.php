        ...
        <div class="d-flex align-items-center justify-content-start">
            <div class="logo-main">
                <a href="{{ route('backend.dashboard') }}" class="navbar-brand">
                    <img class="logo-normal img-fluid" src="{{ asset(Vendorsetting('logo') ?? 'images/logo/frezka.png') }}"
                        height="30" alt="{{ app_name() }}">
                    <img class="logo-normal dark-normal img-fluid"
                        src="{{ asset(Vendorsetting('dark_logo') ?? '/images/logo/dark_logo.png') }}" height="30"
                        alt="{{ app_name() }}">
                    <img class="logo-mini img-fluid"
                        src="{{ asset(Vendorsetting('mini_logo') ?? '/images/logo/mini_logo.png') }}" height="30"
                        alt="{{ app_name() }}">
                </a>
            </div>
