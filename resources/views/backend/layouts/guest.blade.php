...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ setting('logo') ? (str_starts_with(setting('logo'), 'http') ? setting('logo') : asset(setting('logo'))) : asset('/images/logo/frezka.png') }}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ setting('favicon') ? (str_starts_with(setting('favicon'), 'http') ? setting('favicon') : asset(setting('favicon'))) : asset('/images/logo/mini_logo.png') }}">
    <meta name="keyword" content="{{ setting('meta_keyword') }}">
    <meta name="description" content="{{ setting('meta_description') }}">
    <meta name="setting_options" content="{{ setting('customization_json') }}">

    <!-- Shortcut Icon -->
    <link rel="shortcut icon" href="{{ setting('favicon') ? (str_starts_with(setting('favicon'), 'http') ? setting('favicon') : asset(setting('favicon'))) : asset('/images/logo/mini_logo.png') }}">
    <link rel="icon" type="image/ico" href="{{ setting('favicon') ? (str_starts_with(setting('favicon'), 'http') ? setting('favicon') : asset(setting('favicon'))) : asset('/images/logo/mini_logo.png') }}" />
