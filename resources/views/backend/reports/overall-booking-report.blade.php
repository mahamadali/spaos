              ...
              <div>
                ...
                <x-slot name="toolbar">
                    <div class="d-flex gap-2 flex-md-row flex-column">
                        <input type="text" name="booking_date" id="booking_date" placeholder="{{ __('messages.select_date_range') }}" class="booking-date-range form-control" readonly />
                        <select id="column_employee_id" data-placeholder="{{ __('employee.select_employee') }}" name="column_employee_id"
                            data-filter="select" class="select2 form-control flex-grow-1"
