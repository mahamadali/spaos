    ...
    <div class="container mb-5">
        <div class="d-flex align-items-stretch py-4 header">
            <router-link to="/" class="logo d-flex align-items-center">
                ...
                <h4 class="mb-0 ms-3"><strong>{{ __('messages.laravel') }}</strong> Telescope{{ config('app.name') ? ' - ' . config('app.name') : '' }}</h4>
            </router-link>

            <button class="btn btn-muted ms-auto me-3 d-flex align-items-center py-2" v-on:click.prevent="toggleRecording" :title="recording ? $t('messages.pause_recording') : $t('messages.resume_recording')">
            ...
            <button class="btn btn-muted me-3 d-flex align-items-center py-2" v-on:click.prevent="clearEntries" :title="$t('messages.clear_entries')">
            ...
            <button class="btn btn-muted me-3 d-flex align-items-center py-2" :class="{active: autoLoadsNewEntries}" v-on:click.prevent="autoLoadNewEntries" :title="$t('messages.auto_load_entries')">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon" fill="currentColor">
                    <path fill-rule="evenodd" d="M15.312 11.424a5.5 5.5 0 01-9.201 2.466l-.312-.311h2.433a.75.75 0 000-1.5H3.989a.75.75 0 00-.75.75v4.242a.75.75 0 001.5 0v-2.43l.31.31a7 7 0 0011.712-3.138.75.75 0 00-1.449-.39zm1.23-3.723a.75.75 0 00.219-.53V2.929a.75.75 0 00-1.5 0V5.36l-.31-.31A7 7 0 003.239 8.188a.75.75 0 101.448.389A5.5 5.5 0 0113.89 6.11l.311.31h-2.432a.75.75 0 000 1.5h4.243a.75.75 0 00.53-.219z" clip-rule="evenodd" />
                </svg>
            </button>

            <router-link to="/monitored-tags" class="btn btn-muted d-flex align-items-center py-2" :title="$t('messages.monitoring')">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon" fill="currentColor">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/commands" class="nav-link d-flex align-items-center">
                            ...
                            <span>{{ __('messages.commands') }}</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/exceptions" class="nav-link d-flex align-items-center">
                            ...
                            <span>{{ __('messages.exceptions') }}</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/client-requests" class="nav-link d-flex align-items-center">
                            ...
                            <span>{{ __('messages.http_client') }}</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
