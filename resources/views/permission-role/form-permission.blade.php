...
{{ Form::model($data,['route' => $route]) }}
    ...
    <div class="form-group">
        <label class="form-label">{{trans('messages.permission_label_title')}} <span class="text-danger">*</span></label>
        {{ Form::text('title', old('title'), ['class' => 'form-control','id' => 'permission-title', 'placeholder' => trans('messages.permission_title'), 'required']) }}
    </div>
