    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('backend.permission-role.store', $role->id) }}" method="POST">
                    @csrf
                            ...
                            <table class="table table-condensed table-striped mb-0">
                                <thead class="sticky-top">
                                    <tr>
                                        ...
                                        <th class="text-end"><button type="submit" class="btn btn-md btn-secondary">{{ __('messages.save') }}</button>
                                        </th>
                                    </tr>
                                </thead>
