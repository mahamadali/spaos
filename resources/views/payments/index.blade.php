    ...
    <script type="text/javascript" defer>
        ...
        const columns = [{
            ...
            },
            {
                name: 'check',
                data: 'check',
                title: '<div class="checkbox"><input type="checkbox" class="" name="select_all_table" id="select-all-table" onclick="selectAllTable(this)"><label for="select-all-table"></label></div>',
                width: '0%',
                exportable: false,
                orderable: false,
                searchable: false,
